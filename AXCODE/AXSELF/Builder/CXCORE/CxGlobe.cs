...
namespace AXSELF
{
    public class CxGlobe
    {
        ...
        public static string NPath
        {
            get
            {
                return (Path.GetDirectoryName(System.Reflection.Assembly.GetExecutingAssembly().Location)).Replace(@"CODEIT\bin\Debug", "");
            }
        }
    }
    public class TBL
    ...
    public class AutoCode
    {
        ...
        //{
        //    DataTable tbl = new DataTable();
        //    tbl.Columns.Add(MTABLESITEMS.INPUTTYPE, typeof(string));
        ...
        //{
        //    DataTable tbl = new DataTable();
        //    tbl.Columns.Add(MTABLESITEMS.WIDTH, typeof(string));
        //    tbl.Rows.Add(C1);
        //    tbl.Rows.Add(C2);
        //    tbl.Rows.Add(C3);
        //    tbl.Rows.Add(C4);
        ...
        //{
        //    DataTable tbl = new DataTable();
        //    tbl.Columns.Add(MTABLESITEMS.HEIGHT, typeof(string));
        //    tbl.Rows.Add(R1);
        //    tbl.Rows.Add(R2);
        //    tbl.Rows.Add(R3);
        //    tbl.Rows.Add(R4);
        ...
        //{
        //    DataTable tbl = new DataTable();
        //    tbl.Columns.Add(MTABLESITEMS.CPOSITION, typeof(string));
        //    tbl.Rows.Add(P1);
        //    tbl.Rows.Add(P2);
        //    tbl.Rows.Add(P3);
        //    tbl.Rows.Add(P4);
        ...
        //{
        //    DataTable tbl = new DataTable();
        //    tbl.Columns.Add(MTABLESITEMS.RPOSITION, typeof(string));
        ...
        //{
        //    DataTable tbl = new DataTable();
        //    tbl.Columns.Add(MTABLESITEMS.VALIDATE, typeof(string));
        //    tbl.Rows.Add(NO);
        //    tbl.Rows.Add(YES);
        //    return tbl;
        //}
        ...
        //{
        //    DataTable tbl = new DataTable();
        //    tbl.Columns.Add(MTABLESITEMS.ISDEFAULT, typeof(string));
        //    tbl.Rows.Add(NO);
        //    tbl.Rows.Add(YES);
        //    return tbl;
        //}
